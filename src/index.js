...
const game = (() => {
  ...
  return {div, getCurrentLane, startGame, getRound, score, gameOver, getTurn, nextTurn, pass, condemn, players,extraDeploy, infoDisplayUpdate , dispatchEvent, gianInitiative}
})();
